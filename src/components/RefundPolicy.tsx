...
import { Landmark, Euro, CheckCircle } from 'lucide-react';
...
export const RefundPolicy = ({ lang, t }: RefundPolicyProps) => {
  const icons = [Landmark, Euro];
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {t.refundPolicy.items.map((item, index) => {
